...
DOCUMENT_TESTS = [
    ...
    TestCase(
        ...
        commands=[
            ["dv", "add", "MOCK_PYTHON_DOCS", "--sections", "string-methods"]
        ],
        expected_exit_codes=[0],
...
SEARCH_TESTS = [
    ...
    TestCase(
        ...
        commands=[
            ["dv", "search", "batch", "requests", "numpy", "express"]
        ],
        expected_exit_codes=[0],
...
ORGANIZATION_TESTS = [
    ...
    TestCase(
        ...
        commands=[
            ["dv", "add", "MOCK_PYTHON_DOCS"],
            ["dv", "add", "MOCK_JS_DOCS"],
            ["dv", "collection", "create", "programming", "--description", "Programming docs"],
